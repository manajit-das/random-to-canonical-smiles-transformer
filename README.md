...
Download the dataset consisting of three CSV files: `lotus_train42.csv`, `lotus_val42.csv`, and `lotus_test42.csv` Download the dataset from [this Google Drive link](https://drive.google.com/drive/folders/1ildwnYIwyCUPT7Hb7NMnNz6yL2to4EvN?usp=sharing)
